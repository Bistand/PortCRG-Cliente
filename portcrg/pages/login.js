...
export default function Login(){
    ...
    return <div className="h-screen max-w-[1150px] flex mx-auto">
        ...
        <div className="p-24 w-1/2 flex flex-col justify-center items-center gap-8 mt-28">
            ...
            <form onSubmit={validar} className ="flex flex-col justify-center w-full gap-7">
                <input name="user" value={user} onChange={recibiendouser} type ="text" placeholder="USERNAME / EMAIL" className="rounded-[10px] border-solid border-2 border-[#FBF8F8] bg-[#F5E7E7] font-regular text-[12px] p-2" />
                <input name="password" value={password} onChange={recibiendopassword} type="password" placeholder="PASSWORD" className="rounded-[10px] border-solid border-2 border-[#FBF8F8] bg-[#F5E7E7] font-regular text-[12px] p-2"/>
